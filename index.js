...
console.log(addArtist(artists, "29", "Jonathan", "1992 - 18", "Web Design", "American", "I love to code."));
...
function artistInfo(array, name){
  ...
  for(let i = 0; i < array.length; i++){
    ...
    newFiltered.push(array[i].bio);
  }
}
return newFiltered;
}

console.log(artistByCountry(artists, 'Fridah Kahlo'));
